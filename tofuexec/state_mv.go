...
func (tf *OpenTofu) StateMv(ctx context.Context, source string, destination string, opts ...StateMvCmdOption) error {
...
func (tf *OpenTofu) stateMvCmd(ctx context.Context, source string, destination string, opts ...StateMvCmdOption) (*exec.Cmd, error) {
