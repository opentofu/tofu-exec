...
// Please see opentofu/opentofu/command/output.go.
...
func (tf *OpenTofu) Output(ctx context.Context, opts ...OutputOption) (map[string]OutputMeta, error) {
...
func (tf *OpenTofu) outputCmd(ctx context.Context, opts ...OutputOption) *exec.Cmd {
