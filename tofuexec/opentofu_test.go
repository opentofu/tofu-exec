...
func TestSetLog(t *testing.T) {
	...
	if err != nil {
		t.Fatalf("unexpected NewOpenTofu error: %s", err)
	}
...
func TestSetLogCore(t *testing.T) {
	...
	t.Run("case 1: SetLogCore TRACE no SetLogPath", func(t *testing.T) {
	...
	t.Run("case 2: SetLogCore TRACE and SetLogPath", func(t *testing.T) {
		tfLogPath := filepath.Join(td, "test.log")
	...
	t.Run("case 3: SetLogCore DEBUG and SetLogPath", func(t *testing.T) {
		tfLogPath := filepath.Join(td, "test.log")
...
func TestSetLogProvider(t *testing.T) {
	...
	t.Run("case 1: SetLogProvider TRACE no SetLogPath", func(t *testing.T) {
		err := tf.SetLogProvider("TRACE")
	...
	t.Run("case 2: SetLogProvider TRACE and SetLogPath", func(t *testing.T) {
		tfLogPath := filepath.Join(td, "test.log")
	...
	t.Run("case 3: SetLogProvider DEBUG and SetLogPath", func(t *testing.T) {
		tfLogPath := filepath.Join(td, "test.log")
...
// test that a suitable error is returned if NewOpenTofu is called without a valid
// executable path
func TestNoTofuBinary(t *testing.T) {
	td := t.TempDir()

	_, err := NewOpenTofu(td, "")
	if err == nil {
		t.Fatal("expected NewOpenTofu to error, but it did not")
	}
