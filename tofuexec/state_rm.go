...
func (tf *OpenTofu) StateRm(ctx context.Context, address string, opts ...StateRmCmdOption) error {
...
func (tf *OpenTofu) stateRmCmd(ctx context.Context, address string, opts ...StateRmCmdOption) (*exec.Cmd, error) {
