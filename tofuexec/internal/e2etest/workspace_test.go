...
func TestWorkspace_multiple(t *testing.T) {
	runTest(t, "workspaces", func(t *testing.T, tfv *version.Version, tf *tofuexec.OpenTofu) {
...
func assertWorkspaceList(t *testing.T, tf *tofuexec.OpenTofu, expectedCurrent string, expectedWorkspaces ...string) {
...
func assertWorkspaceShow(t *testing.T, tf *tofuexec.OpenTofu, expectedWorkspace string) {
