...
func TestImport(t *testing.T) {
	...
	runTest(t, "import", func(t *testing.T, tfv *version.Version, tf *tofuexec.OpenTofu) {
		...
		err = tf.Import(ctx, resourceAddress, expectedID, tofuexec.DisableBackup(), tofuexec.Config(tf.WorkingDir()))
		if err != nil {
			t.Fatal(err)
		}
