...
func TestTest(t *testing.T) {
	runTest(t, "test_command_passing", func(t *testing.T, tfv *version.Version, tf *tofuexec.OpenTofu) {
		// Use Core() to enable pre-release support
		if tfv.Core().LessThan(testMinVersion) {
			t.Skip("test command is not available in this OpenTofu version")
		}
...
func TestTestError(t *testing.T) {
	runTest(t, "test_command_failing", func(t *testing.T, tfv *version.Version, tf *tofuexec.OpenTofu) {
		// Use Core() to enable pre-release support
		if tfv.Core().LessThan(testMinVersion) {
			t.Skip("test command is not available in this OpenTofu version")
		}
