...
func (tf *OpenTofu) ForceUnlock(ctx context.Context, lockID string, opts ...ForceUnlockOption) error {
...
func (tf *OpenTofu) forceUnlockCmd(ctx context.Context, lockID string, opts ...ForceUnlockOption) (*exec.Cmd, error) {
	...
	if c.dir != "" {
		...
		if err != nil {
			return nil, fmt.Errorf("[DIR] option was removed in OpenTofu v0.15.0")
		}
