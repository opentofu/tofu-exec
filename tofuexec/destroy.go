...
func (tf *OpenTofu) Destroy(ctx context.Context, opts ...DestroyOption) error {
...
func (tf *OpenTofu) DestroyJSON(ctx context.Context, w io.Writer, opts ...DestroyOption) error {
	err := tf.compatible(ctx, tf0_15_3, nil)
	if err != nil {
		return fmt.Errorf("tofu destroy -json was added in 0.15.3: %w", err)
	}
...
func (tf *OpenTofu) destroyCmd(ctx context.Context, opts ...DestroyOption) (*exec.Cmd, error) {
...
func (tf *OpenTofu) destroyJSONCmd(ctx context.Context, opts ...DestroyOption) (*exec.Cmd, error) {
	c := defaultDestroyOptions
...
func (tf *OpenTofu) buildDestroyArgs(c destroyConfig) []string {
...
func (tf *OpenTofu) buildDestroyCmd(ctx context.Context, c destroyConfig, args []string) (*exec.Cmd, error) {
