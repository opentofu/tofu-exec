...
var (
	...
	tofu1_6_0 = version.Must(version.NewVersion("1.6.0"))
)
...
// is set to true.
func (tf *OpenTofu) Version(ctx context.Context, skipCache bool) (tfVersion *version.Version, providerVersions map[string]*version.Version, err error) {
	tf.versionLock.Lock()
...
// version does not use the locking on the OpenTofu instance and should probably not be used directly, prefer Version.
func (tf *OpenTofu) version(ctx context.Context) (*version.Version, map[string]*version.Version, error) {
...
func (tf *OpenTofu) versionFromPlaintext(ctx context.Context) (*version.Version, map[string]*version.Version, error) {
...
func (tf *OpenTofu) compatible(ctx context.Context, minInclusive *version.Version, maxExclusive *version.Version) error {
...
// versionInRange checks compatibility of the OpenTofu version. The minimum is inclusive and the max
