...
func (tf *OpenTofu) Import(ctx context.Context, address, id string, opts ...ImportOption) error {
...
func (tf *OpenTofu) importCmd(ctx context.Context, address, id string, opts ...ImportOption) (*exec.Cmd, error) {
