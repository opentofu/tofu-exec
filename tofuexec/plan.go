...
// with either 0 or 2.
func (tf *OpenTofu) Plan(ctx context.Context, opts ...PlanOption) (bool, error) {
...
func (tf *OpenTofu) PlanJSON(ctx context.Context, w io.Writer, opts ...PlanOption) (bool, error) {
	err := tf.compatible(ctx, tf0_15_3, nil)
	if err != nil {
		return false, fmt.Errorf("tofu plan -json was added in 0.15.3: %w", err)
	}
...
func (tf *OpenTofu) planCmd(ctx context.Context, opts ...PlanOption) (*exec.Cmd, error) {
...
func (tf *OpenTofu) planJSONCmd(ctx context.Context, opts ...PlanOption) (*exec.Cmd, error) {
	c := defaultPlanOptions
...
func (tf *OpenTofu) buildPlanArgs(ctx context.Context, c planConfig) ([]string, error) {
...
func (tf *OpenTofu) buildPlanCmd(ctx context.Context, c planConfig, args []string) (*exec.Cmd, error) {
