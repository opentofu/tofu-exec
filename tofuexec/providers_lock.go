...
func (tf *OpenTofu) ProvidersLock(ctx context.Context, opts ...ProvidersLockOption) error {
	err := tf.compatible(ctx, tf0_14_0, nil)
	if err != nil {
		return fmt.Errorf("tofu providers lock was added in 0.14.0: %w", err)
	}
...
func (tf *OpenTofu) providersLockCmd(ctx context.Context, opts ...ProvidersLockOption) *exec.Cmd {
